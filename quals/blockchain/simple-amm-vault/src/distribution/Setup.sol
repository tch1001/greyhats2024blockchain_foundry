...
contract Setup {
    ...
    constructor() {
        ...
        /* 
        SimpleVault setup:
        - Deposit 1000 GREY into the vault (1 share = 1 GREY)
        - Distribute 1000 GREY as rewards  (1 share = 2 GREY)
        */
        ...
        */
        vault.approve(address(amm), 1000e18); // 1000 SHARES
        grey.approve(address(amm), 2000e18); // 2000 GREY (from setup)
